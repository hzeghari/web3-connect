        ...
        <div className="drop-shadow-2xl rounded-2xl p-4 bg-white dark:bg-gray-900 w-[400px] h-[300px] m-auto relative">
            <div className="flex flex-col w-full h-full space-y-4 text-center">
                ...
                <div className="flex flex-col content-start justify-center w-auto h-auto">
                    ...
                    <h1 className="sm:text-xl text-base font-bold text-gray-900">Mainnet</h1>
                ...
                <div className="flex flex-col content-start justify-center w-auto h-auto">
                    ...
                    <h1 className="sm:text-xl text-base font-bold text-gray-900">0x14...63a0</h1>
                
                </div>
                
                <button className="flex items-center justify-center mx-auto pt-3 pb-3 w-[300px] h-[60px] cursor-pointer transition ease-in duration-200 normal-case rounded-[10px] text-[#f96666] text-xl font-black focus:outline-none">
